...
<!-- Form de Cadastro de Campeonato -->
                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="form-group" method="POST" action="<?php echo site_url('CadastraCampeonato/cadastra');?>">
                                            ...
                                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" id="botao_cadastrar_campeonato">Cadastrar</button>                         
                                        </form>
                                        <?php 
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Campeonatos</h4>
